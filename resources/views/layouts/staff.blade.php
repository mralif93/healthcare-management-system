            ...
            <header class="h-16 bg-white/80 backdrop-blur-xl border-b border-indigo-100 px-8 flex items-center justify-between z-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="relative w-9 h-9 rounded-lg border border-indigo-100 text-slate-500 flex items-center justify-center hover:bg-indigo-50 transition-all active:scale-95">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak [x-cloak]:hidden
                             ...
                             class="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-indigo-50 z-50 overflow-hidden">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak [x-cloak]:hidden
                            ...
                            <a href="{{ route('staff.profile') }}" class="flex items-center space-x-2 px-4 py-2 hover:bg-slate-50 text-slate-600 hover:text-brand-600 transition-colors">
