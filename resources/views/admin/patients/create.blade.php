...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-slate-100 bg-slate-50/50">
            <h3 class="text-xs font-bold text-slate-900 uppercase tracking-widest italic">Personal & Medical Background</h3>
        </div>

        <form action="{{ route('admin.patients.store') }}" method="POST" class="p-8 space-y-8">
            @csrf
            ...
            <!-- Hidden status default to active -->
