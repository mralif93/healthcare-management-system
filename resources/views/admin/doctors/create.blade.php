...
@section('page_title', 'New Doctor Account')
...
<div class="space-y-6">
    ...
    <div class="bg-brand-600 rounded-2xl p-8 text-white shadow-xl shadow-brand-100 relative overflow-hidden animate__animated animate__fadeInUp animate__faster">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
                ...
                <h1 class="text-2xl font-black tracking-tight">Add New Doctor</h1>
                <p class="text-sm text-white/70 mt-1">Create a new doctor login account</p>
            </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex items-center space-x-3">
            ...
            <div>
                <h3 class="text-sm font-bold text-slate-900">Doctor Account Details</h3>
                <p class="text-[10px] text-slate-400 font-medium mt-0.5">Fill in the doctor's credentials and professional information</p>
            </div>
        </div>
            ...
            <div class="p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Dr. Full Name"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required placeholder="doctor@hospital.com"
                            class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all shadow-sm">
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="+60 12-345 6789"
                            class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all shadow-sm">
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="specialization" id="specialization" value="{{ old('specialization') }}" placeholder="e.g. Cardiology, General Practice"
                            class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all shadow-sm">
                    </div>
                    ...
                    <div class="space-y-1.5">
                        <label for="password" class="flex items-center gap-1.5 text-xs font-semibold text-slate-600">
                            <i class="hgi-stroke hgi-lock-password text-slate-400"></i> Password <span class="text-red-400">*</span>
                        </label>
