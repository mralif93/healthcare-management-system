        ...
        <form action="{{ route('admin.appointments.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    <label for="patient_id" class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Assign Patient</label>
                ...
                <!-- Doctor -->
                <div class="space-y-1.5">
                    <label for="doctor_id" class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Assign Doctor</label>
                ...
                <!-- Status -->
                <div class="space-y-1.5">
                    <label for="status" class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Initial Status</label>
            ...
            <!-- Internal Notes -->
            <div class="space-y-1.5">
                <label for="notes" class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Internal Notes (Optional)</label>
